...
RUN ./bin/elasticsearch-plugin install http://liweijia-img.oss-cn-beijing.aliyuncs.com/liweijia/elasticsearch-analysis-ik-7.5.0.zip
RUN ./bin/elasticsearch-plugin install http://liweijia-img.oss-cn-beijing.aliyuncs.com/liweijia/elasticsearch-analysis-pinyin-7.5.0.zip
